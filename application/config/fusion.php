...
|--------------------------------------------------------------------------
*/
$config['server_name'] = "WoW Argenta";
...
|
*/
$config['keywords'] = "wow argenta, private server, servidor privado";
$config['description'] = "WoW Argenta descripcion";
